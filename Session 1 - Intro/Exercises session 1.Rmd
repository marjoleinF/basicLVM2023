...
MacKinnon (2008, p. 113) provides a dataset from a hypothetical study of teacher expectancies and student achievement. His path model is shown in Beaujean Figure 2.10 and the sample covariances are given below. The sample size is $n = 40$.
